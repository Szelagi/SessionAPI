...
public class SignTagQuery implements Serializable {
    @NotNull
    private final ArrayList<SignTag> elements;
    @NotNull
    private final String tag;
    public SignTagQuery(@NotNull String tag,
                        @NotNull ArrayList<SignTag> elements) throws NoTagException {
        if (elements.isEmpty()) throw new NoTagException(tag);
        this.tag = tag;
